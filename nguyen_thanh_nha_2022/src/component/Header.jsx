...
import { setCommentReducer } from "../redux/commentsReducer";
import { setPostsReducer } from "../redux/postsReducer";
import { setUserReducer } from "../redux/usersReducer";
const comments = [
  {
    id: 1,
    owner: 1,
...
export default function Header() {
  ...
  useEffect(() => {
    const action = setPostsReducer(posts);
    dispatch(action);
    const actionComment = setCommentReducer(comments);
    dispatch(actionComment);
    const actionUser = setUserReducer(users);
    dispatch(actionUser);
  }, []);
  return (
    <div className="header  p-3 ">
      ...
      <div className="blogs text-center">Blogs</div>
      <div className="user">
        <i className="fas fa-user-alt px-2"></i>
